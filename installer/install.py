...
BeginGroup(GROUP_VERTICAL)
AddLabel(label=loc.GetString(loc.MSG_DEST_INTRO), align=ALIGN_LEFT, weight=6)
BeginGroup(GROUP_VERTICAL)
AddSpace(weight=1)
DestRadioID = AddRadioButton([loc.GetString(loc.MSG_DEST_OPT_DEVS), loc.GetString(loc.MSG_DEST_OPT_KICKSTART)], weight=0)
AddSpace(weight=1)
EndGroup()
AddSpace(weight=1)
EndGroup()
